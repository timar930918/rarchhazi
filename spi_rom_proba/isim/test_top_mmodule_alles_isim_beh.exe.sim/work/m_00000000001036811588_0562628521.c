...
LAB30:    if (*((unsigned int *)t148) > 0)
        goto LAB31;

LAB32:    if (*((unsigned int *)t4) > 0)
        goto LAB33;

LAB34:    memcpy(t3, t159, 8);
...
LAB27:    t153 = (t0 + 3288U);
    t154 = *((char **)t153);
    t153 = ((char*)((ng1)));
    xsi_vlogtype_concat(t152, 32, 32, 2U, t153, 24, t154, 8);
    goto LAB28;

LAB29:    t159 = ((char*)((ng5)));
    goto LAB30;

LAB31:    xsi_vlog_unsigned_bit_combine(t3, 32, t152, 32, t159, 32);
    goto LAB35;

LAB33:    memcpy(t3, t152, 8);
    goto LAB35;
...
extern void work_m_00000000001036811588_0562628521_init()
{
	...
	xsi_register_didat("work_m_00000000001036811588_0562628521", "isim/test_top_mmodule_alles_isim_beh.exe.sim/work/m_00000000001036811588_0562628521.didat");
